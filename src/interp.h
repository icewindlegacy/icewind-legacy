...
DECLARE_DO_FUN( do_control_animal );
...
DECLARE_DO_FUN( do_build_shelter	);
DECLARE_DO_FUN( do_blanket		);
...
DECLARE_DO_FUN( do_ascii_map );
DECLARE_DO_FUN( do_smallmap );
DECLARE_DO_FUN( do_printmap );
DECLARE_DO_FUN( do_test_new_combat );